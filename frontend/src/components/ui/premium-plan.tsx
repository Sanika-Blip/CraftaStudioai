      ...
      >
        ...
        <div className="flex flex-col gap-4 p-8 pt-0">
          <div className="flex items-center justify-center gap-3">
            <button 
              className="flex items-center gap-2 px-6 py-2.5 bg-[#FD572D] text-white rounded-full text-[13px] font-bold shadow-xl hover:scale-105 active:scale-95 transition-all"
              onClick={() => {
